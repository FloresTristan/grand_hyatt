...
"[project]/.next-internal/server/app/api/admin/events/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/admin/events/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await supabase.from('events_with_status').select('id,title,subheading,description,image_url,publish_at,unpublish_at,computed_status,"order",updated_at,starts_at,ends_at,published').order('order', {
        ascending: true
    }).order('publish_at', {
        ascending: false,
        nullsFirst: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b0d39e5b._.js.map